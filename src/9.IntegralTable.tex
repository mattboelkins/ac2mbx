...
\ee
%& 12. $\ds \int \sin^2(u) \, du = \frac{1}{2}u - \frac{1}{4} \sin(2u) + C$ \\
%& 13. $\ds \int \cos^2(u) \, du = \frac{1}{2}u + \frac{1}{4} \sin(2u) + C$ \\ 
%& 14. $\ds \int \sin^n(u) \, du = -\frac{1}{n}\sin^{n-1}(u) \cos(u) + \frac{n-1}{n} \int \sin^{n-2}(u) \, du$ \\
%& 15. $\ds \int \cos^n(u) \, du = \frac{1}{n}\cos^{n-1}(u) \sin(u) + \frac{n-1}{n} \int \cos^{n-2}(u) \, du$ \\
%& 16. $\ds \int u^n \sin(u) \, du = -u^n \cos(u) + n \int u^{n-1} \cos(u) \, du$ \\
%& 17. $\ds \int u^n \cos(u) \, du = u^n \sin(u) - n \int u^{n-1} \sin(u) \, du$ \\
%& 18. $\ds \int u^n e^u \, du = u^n e^u - n \int u^{n-1} e^u \, du $ \\
%& 19. $\ds \int e^{au} \sin (bu) \, du = \frac{e^{au}}{a^2 + b^2} (a \sin (bu) - b \cos (bu)) + C$ \\
%& 20. $\ds \int e^{au} \cos (bu) \, du = \frac{e^{au}}{a^2 + b^2} (a \cos (bu) + b \sin (bu)) + C$ \\
%21. $\ds \int \sec(u) \, du = \ln | \sec(u) + \tan(u) | + C$ \\
%& 22. $\ds \int \csc(u) \, du = \ln | \csc(u) - \cot(u) | + C$ \\
